...
| [ADR-2042](ADR-2042-vault-migrate-converter.md) | `vault-migrate` is the sole Logseq→Obsidian converter — deterministic, output-dir by default, preserve-and-report | VAULT-corpus-format | 2026-09-02 | proposed | none | inactive | — | — | jjohare | visionclaw |
