...
| [ADR-2038](ADR-2038-boot-time-profile-assertion.md) | Boot-time deployment-profile assertion with illegal-combination abort | SECURITY-profiles | 2026-08-31 | proposed | complete | staged | — | — | jjohare | visionclaw |
...
| [ADR-2045](ADR-2045-remove-dead-supervision-machinery.md) | Remove the dead ActorLifecycleManager supervision machinery | BASELINE-architecture | 2026-09-05 | accepted | partial | live | — | — | jjohare | visionclaw |
