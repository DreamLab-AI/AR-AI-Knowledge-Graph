...
| [ADR-2040](ADR-2040-obsidian-vault-frontmatter-gate.md) | The authored corpus is an Obsidian vault; YAML frontmatter `public`/`owl-class` gate KG inclusion with bounded Logseq tolerance | VAULT-corpus-format | 2026-09-02 | proposed | none | inactive | ADR-2014 | — | jjohare | visionclaw |
| [ADR-2041](ADR-2041-graph-settings-key-knowledge.md) | The knowledge-graph settings key and graph-type value are `knowledge`; `logseq` is a read-only alias for one release | VAULT-corpus-format | 2026-09-02 | proposed | none | inactive | — | — | jjohare | visionclaw |
