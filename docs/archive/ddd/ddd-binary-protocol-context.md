...
> **Related**: [PRD-007](../prd/PRD-007-binary-protocol-unification.md) · [ADR-061](../adr/ADR-061-binary-protocol-unification.md) · ADR-031 · [ADR-050 §H2](../adr/ADR-050-pod-backed-kgnode-schema.md) · [ADR-037 (Superseded)](../adr/superseded/ADR-037-binary-protocol-consolidation.md)
