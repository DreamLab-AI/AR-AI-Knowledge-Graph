...
- [PRD-QE-002 — XR Godot quality engineering](PRD-QE-002-xr-godot-quality-engineering.md) (test strategy this pass extends)
- [`ddd-xr-godot-context.md`](ddd-xr-godot-context.md) (BC22 bounded context — updated alongside)
- [`binary-protocol.md`](binary-protocol.md) / ADR-061 (binary protocol — **stale at 28 B/node**; live wire is V3 52 B, ADR-102 §2)
