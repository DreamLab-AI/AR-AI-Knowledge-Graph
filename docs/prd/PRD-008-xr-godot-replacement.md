...
- ADR-032 (RATK integration) — RATK was a Babylon/Three.js typed-anchor wrapper; **moot** once we leave the browser
- ADR-033 (Vircadia decoupling) — adapter pattern around `quest3AutoDetector`; **moot** once Vircadia is removed entirely
**Related (this PRD's siblings, to be authored):**
- [ADR-071 — XR client replatform to Godot 4 + godot-rust](../adr/ADR-071-godot-rust-xr-replacement.md) (decision record for §4–§5)
- [`docs/ddd-xr-godot-context.md`](../ddd/ddd-xr-godot-context.md) (bounded-context model — supersedes [`docs/ddd-xr-bounded-context.md`](../ddd/ddd-xr-godot-context.md))
- `docs/PRD-QE-002-xr-godot-quality-engineering.md` (QE plan, gdext crate coverage, soak harness)
- `docs/xr-vircadia-removal-plan.md` (file-by-file removal manifest)
- [`docs/xr-godot-system-architecture.md`](../explanation/xr-architecture.md) (architecture deep-dive)
- [`docs/xr-godot-threat-model.md`](../explanation/security-model.md) (presence WS auth, pose validation, voice, anchor PII)
...
- [`docs/binary-protocol.md`](../reference/binary-protocol.md) (single-source spec — extended in §5.2 below with an avatar pose frame)
...
manifest lives in `docs/xr-vircadia-removal-plan.md`.
